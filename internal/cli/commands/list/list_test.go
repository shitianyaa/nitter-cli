...
// End-to-end tests for `twitter list`: httptest fake instances, temp-HOME
...
func TestListOutputsRows(t *testing.T) {
	home := tempHome(t)
...
func TestListEmptyResultPrintsHintAndExitsZero(t *testing.T) {
